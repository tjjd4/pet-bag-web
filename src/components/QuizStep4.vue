...
const getFieldName = (section: Q2SelectionType, questionId: number): keyof FormDataQ3 => {
...
const sectionHasAnswers = (section: Q2SelectionType): boolean => {
    const sectionKeys = Object.keys(formData).filter(key => key.startsWith(section)) as Array<keyof FormDataQ3>;
...
const sectionIsComplete = (section: Q2SelectionType): boolean => {
    const questions = phase3Questions[section];
        ...
        <div class="flex flex-col gap-2 mb-8">
            <div v-for="section in sectionOptions" :key="section.value">
                ...
                <transition name="fade-slide">
                    ...
                    >
                        <div
                            v-for="question in phase3Questions[section.value]"
                            :key="question.id"
                            class="mb-6"
                        >
